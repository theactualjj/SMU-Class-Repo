...
* Once everyone has completed the activity, open up `programmers.js` in `05-Programmers` inside of Sublime and discuss it with the class whilst answering any questions which they might have.
...
* Open up `programmersWithPrompt.js` in `06-ProgrammersWithPrompt` within Sublime and start to go over the code with your students.
...
* After a short amount of time, call your class' attention back to the front and open up `programmersLoop-noRecursion.js` in `07-ProgrammersLoop` within Sublime and go over the code written with your class. Ask them all what they think this code will print to the console.
...
* Open up `programmersLoop-recursion.js` in `07-ProgrammersLoop` within Sublime and go over the code with your class.
...
* Open up the folder `09-MovieManager` within sublime and show your students how we are exporting a constructor function from one file - `castMember.js` for example - and calling upon it within another; in this case `movie.js`
