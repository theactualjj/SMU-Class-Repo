## 6.3 Lesson Plan - Real-World API Application Development
...
* Once you've taken a few minutes, open up [nytarticle-search.herokuapp.com](http://nytarticle-search.herokuapp.com/) in the browser and show them what they'll be building later today.
...
* Open the `4-pausing-gifs-solution.html` in `15-PausingGifs` file in Sublime and walk students through the solution.
...
* Re-introduce the NYT Article Search Application by visiting this link [nytarticle-search.herokuapp.com](http://nytarticle-search.herokuapp.com/).
...
* Then offer students the following commentary:
  ...
  * Let them know that they should be partnering in sub-pairs. With one pair working on "front-end" and the second pair working on "back-end".

  * Let them know that they should take honest stock of their abilities and focus on what they feel comfortable doing.

  * Let them know that when working as front-end and back-end teams they need to learn to "anticipate" what the other pair will give them (i.e. back-end team should expect text inputs, front-end teams should expect to create dynamic elements to hold retrieved data, etc.)
...
* Recap the event by explaining that today's activity should have showed you that:
  ...
  * Working across front-end and back-end requires careful coordination; and
