...
* Then visit the link that gets generated, and show students the JSON that was generated. Be sure to add the following `apikey` parameter to the generated URL: `40e9cece`. Example: <http://www.omdbapi.com/?t=Space+Jam&apikey=40e9cece>
...
* Using this <http://www.omdbapi.com/?t=Forrest+Gump&y=&plot=short&apikey=40e9cece> as an example, have students break down the URL.
...
* Then ask students how they would show multiple movies that meet a condition? (i.e. how would you get all movies with the word `Matrix` in it). SOLUTION: Use the `/s` format: <http://www.omdbapi.com/?s=Matrix&y=&plot=short&apikey=40e9cece>
...
* Review the solution to the previous activity `3-ajax-to-html-solution` in `03-AJAX_to_HTML`.
