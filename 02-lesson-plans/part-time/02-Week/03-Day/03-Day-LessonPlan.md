...
* Finally, visit <https://mean-google-maps.herokuapp.com/>. Point out that this is a "real" website for adding users to a membership base. Have students complete the same rows and columns activity on the layout. 
